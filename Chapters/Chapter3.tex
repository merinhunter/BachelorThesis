...
%----------------------------------------------------------------------------------------
 ...
 En una \keyword{clave pública RSA} válida, \keyword{n} es un producto de \keyword{u}\footnote{La ventaja de usar más de dos factores primos es que tendríamos un menor coste computacional para el desencriptador y las primitivas de firma.} números primos impares distintos
 \[ r_i, i = 1, 2, ..., u \]
