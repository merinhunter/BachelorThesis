...
La comunicación digital ha supuesto un increíble avance en la transmisión de información. Sin embargo, esto también ha desencadenado nuevas formas de robarla y falsificarla. Para solucionarlo existen multitud de protocolos de seguridad que permiten cifrarla y firmarla, con el fin de mantener su confidencialidad, su integridad y su autenticidad.

De la mezcla de estos protocolos surgen múltiples aplicaciones que permiten realizar comunicaciones preservando estas tres propiedades. Estas aplicaciones existen para la inmensa mayoría de las plataformas actuales y hacen uso de la combinación de diversos algoritmos.

En este contexto, este Trabajo de Fin de Grado se enfoca en el desarrollo de una aplicación que permita llevar a cabo comunicaciones seguras entre usuarios. Esta aplicación se va a desarrollar para el Sistema Operativo Android y va a hacer uso de varios algoritmos de cifrado conocidos como RSA o AES.
\end{abstract}
